    module control_unit(
        ...
        always @(*) begin
            case (opcode)
                ...
                7'b010_0011: {ImmSel, RegWrite, AUIPC, ALUSrc, MemWrite, ResultSrc, Branch, ALUOp, Jump, JumpReg} = 14'b100_0_0_1_1_00_0_00_0_0;
                ...
                //──────────────────────────────────────\\
                // FENCE
                7'b000_1111: {ImmSel, RegWrite, AUIPC, ALUSrc, MemWrite, ResultSrc, Branch, ALUOp, Jump, JumpReg} = 14'b000_0_0_0_0_00_0_00_0_0;
                // ECALL - EBREAK
                7'b111_0011: {ImmSel, RegWrite, AUIPC, ALUSrc, MemWrite, ResultSrc, Branch, ALUOp, Jump, JumpReg} = 14'b000_0_0_0_0_00_0_00_0_0;
