module immediate_generate(
    ...
    always @(*) begin
        case (opcode)
            ...
            7'b110_0111: immediate_extend = {{20{instruction[31]}}, instruction[31:20]}; // JALR

            7'b110_0011: immediate_extend = {{20{instruction[31]}}, instruction[7], instruction[30:25], instruction[11:8], 1'b0}; // BEQ, BNE

            7'b000_0011: immediate_extend = {{20{instruction[31]}}, instruction[31:20]}; // LW
            7'b010_0011: immediate_extend = {{20{instruction[31]}}, instruction[31:25], instruction[11:7]}; //SW

            7'b001_0011: immediate_extend = {{20{instruction[31]}}, instruction[31:20]}; // ADDI
